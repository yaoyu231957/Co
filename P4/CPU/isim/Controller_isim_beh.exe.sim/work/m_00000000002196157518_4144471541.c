...
#endif
static const char *ng0 = "C:/Users/86139/Desktop/courses/co/P4/CPU/Controller.v";
...
LAB69:    xsi_vlog_unsigned_bit_combine(t175, 2, t206, 2, t211, 2);
    goto LAB73;
...
LAB38:    t281 = (t0 + 7232);
    ...
    *((unsigned int *)t291) = (t293 | t287);
    xsi_driver_vfirst_trans(t281, 0, 1);
    t294 = (t0 + 6944);
    *((int *)t294) = 1;
...
LAB104:    if (*((unsigned int *)t245) > 0)
        goto LAB105;

LAB106:    memcpy(t244, t280, 8);

LAB107:    goto LAB85;

LAB86:    xsi_vlog_unsigned_bit_combine(t208, 2, t239, 2, t244, 2);
    goto LAB90;
...
LAB101:    t280 = ((char*)((ng1)));
    goto LAB102;

LAB103:    xsi_vlog_unsigned_bit_combine(t244, 2, t275, 2, t280, 2);
    goto LAB107;

LAB105:    memcpy(t244, t275, 8);
    goto LAB107;
...
LAB78:    memcpy(t295, t257, 8);

LAB79:    memset(t327, 0, 8);
    t328 = (t295 + 4);
...
LAB85:    if (*((unsigned int *)t288) != 0)
        goto LAB86;

LAB87:    t296 = *((unsigned int *)t257);
...
LAB104:    t379 = ((char*)((ng4)));
    goto LAB105;

LAB106:    xsi_vlog_unsigned_bit_combine(t3, 1, t374, 1, t379, 1);
    goto LAB110;
...
LAB74:    t452 = (t0 + 7360);
    ...
    t458 = t457;
    t459 = (t3 + 4);
    t460 = *((unsigned int *)t3);
    t457 = (t457 & t460);
    t461 = *((unsigned int *)t459);
    t458 = (t458 & t461);
    t462 = (t456 + 4);
    t463 = *((unsigned int *)t456);
    *((unsigned int *)t456) = (t463 | t457);
    t464 = *((unsigned int *)t462);
    *((unsigned int *)t462) = (t464 | t458);
    xsi_driver_vfirst_trans(t452, 0, 2);
    t465 = (t0 + 6976);
    *((int *)t465) = 1;
...
LAB102:    memcpy(t371, t332, 8);

LAB103:    memset(t243, 0, 8);
    t399 = (t371 + 4);
...
LAB116:    if (*((unsigned int *)t399) != 0)
        goto LAB117;

LAB118:    t406 = (t243 + 4);
    t407 = *((unsigned int *)t243);
    t408 = *((unsigned int *)t406);
    t409 = (t407 || t408);
    if (t409 > 0)
        goto LAB119;

LAB120:    t411 = *((unsigned int *)t243);
    t412 = (~(t411));
...
LAB122:    if (*((unsigned int *)t406) > 0)
        goto LAB123;

LAB124:    if (*((unsigned int *)t243) > 0)
        goto LAB125;

LAB126:    memcpy(t242, t415, 8);

LAB127:    goto LAB69;

LAB70:    xsi_vlog_unsigned_bit_combine(t3, 3, t237, 3, t242, 3);
    goto LAB74;
...
LAB105:    *((unsigned int *)t347) = 1;

LAB107:    memset(t363, 0, 8);
    t364 = (t347 + 4);
...
LAB119:    t410 = ((char*)((ng13)));
    goto LAB120;

LAB121:    t417 = (t0 + 1048U);
    t418 = *((char **)t417);
    t417 = ((char*)((ng7)));
    memset(t419, 0, 8);
    t420 = (t418 + 4);
...
LAB129:    *((unsigned int *)t419) = 1;

LAB131:    memset(t416, 0, 8);
    t435 = (t419 + 4);
...
LAB141:    if (*((unsigned int *)t416) > 0)
        goto LAB142;

LAB143:    memcpy(t415, t451, 8);

LAB144:    goto LAB122;

LAB123:    xsi_vlog_unsigned_bit_combine(t242, 3, t410, 3, t415, 3);
    goto LAB127;

LAB125:    memcpy(t242, t410, 8);
    goto LAB127;
...
LAB136:    t446 = ((char*)((ng4)));
    goto LAB137;

LAB138:    t451 = ((char*)((ng1)));
    goto LAB139;

LAB140:    xsi_vlog_unsigned_bit_combine(t415, 3, t446, 3, t451, 3);
    goto LAB144;

LAB142:    memcpy(t415, t446, 8);
    goto LAB144;
...
LAB70:    xsi_vlog_unsigned_bit_combine(t3, 1, t237, 1, t242, 1);
    goto LAB74;
...
extern void work_m_00000000002196157518_4144471541_init()
{
	static char *pe[] = {(void *)Cont_49_0,(void *)Cont_51_1,(void *)Cont_56_2,(void *)Cont_57_3,(void *)Cont_61_4,(void *)Cont_62_5,(void *)Cont_63_6,(void *)Cont_64_7,(void *)Cont_65_8,(void *)Cont_66_9,(void *)Cont_67_10};
	xsi_register_didat("work_m_00000000002196157518_4144471541", "isim/Controller_isim_beh.exe.sim/work/m_00000000002196157518_4144471541.didat");
